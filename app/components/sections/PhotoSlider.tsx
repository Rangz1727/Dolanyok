...
export default function PhotoSlider() {
  const logos = [
    ...
    { id: 9, src: "/brand/1 (5).png" },
    { id: 10, src: "/brand/1 (6).jpg" },
    { id: 11, src: "/brand/1 (6).png" },
    { id: 12, src: "/brand/1 (7).jpg" },
    { id: 13, src: "/brand/1 (7).png" },
    { id: 14, src: "/brand/1 (8).jpg" },
    { id: 15, src: "/brand/1 (8).png" },
    { id: 16, src: "/brand/1 (9).jpg" },
    { id: 17, src: "/brand/1 (9).png" },
    { id: 18, src: "/brand/1 (10).jpg" },
    { id: 19, src: "/brand/1 (10).png" },
    { id: 20, src: "/brand/1 (11).jpg" },
