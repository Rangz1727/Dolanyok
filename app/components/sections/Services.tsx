  ...
  const services = [
    {
      ...
      icon: "📣",
      // Kita tambahkan penanda grid untuk layout bento
  ...
  return (
    <section className="py-24 px-6 bg-slate-950 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header Section - Tetap Mengikuti Gaya Kamu */}
        ...
        {/* Bento Grid Layout - Kotak-kotak yang lebih elegan */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(300px,_auto)]">
          {services.map((service, index) => (
            <div 
              ...
              className={`group relative p-10 rounded-[3rem] bg-slate-900/50 border border-slate-800 hover:border-[#00f7a7]/50 transition-all duration-500 overflow-hidden flex flex-col justify-between ${service.gridClass}`}
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-[#00f7a7] transition-colors uppercase tracking-tighter">
                  {service.title}
                </h3>
              ...
              {/* Tags Layanan di bagian bawah kotak */}
        ...
        {/* CTA Section - Tetap Mengikuti Gaya Kamu */}
        <div className="mt-20 p-1 bg-gradient-to-r from-slate-900 via-[#06373a] to-slate-900 rounded-[3rem]" data-aos="zoom-in">
           <div className="bg-slate-950 rounded-[2.9rem] px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="text-center md:text-left">
                <h4 className="text-2xl font-bold text-white mb-2 uppercase tracking-tight">Interested in working together??</h4>
                <p className="text-slate-400">Mari kolaborasikan visi Anda dengan kreativitas media kami.</p>
              </div>
              <a href="https://wa.me/6285173341917" className="px-10 py-4 bg-[#00f7a7] text-[#06373a] font-black rounded-2xl hover:scale-105 transition-transform shadow-[0_0_20px_rgba(0,247,167,0.3)] tracking-widest text-xs">
                SEND MESSAGE
              </a>
           </div>
        </div>
