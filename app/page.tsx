        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 md:gap-20 relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="#kontak" className="bg-[#00f7a7] hover:bg-emerald-400 text-[#06373a] px-8 py-4 rounded-2xl font-bold transition-all shadow-lg shadow-[#00f7a7]/20 flex items-center gap-2 tracking-widest text-xs uppercase">
                📩 Collaborate
              </a>
            </div>
          </motion.div>
