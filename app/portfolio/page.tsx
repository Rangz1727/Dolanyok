          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20 text-left">
            ...
            >
              ...
              <div className="bg-slate-900/50 p-6 rounded-3xl border border-slate-800 backdrop-blur-md">
                <a href="mailto:halo@dolanyok.com" className="w-full block py-3 bg-[#00f7a7] text-[#06373a] font-black text-xs text-center rounded-xl hover:scale-105 active:scale-95 transition-all shadow-lg shadow-[#00f7a7]/10">SEND MESSAGE</a>
              </div>
            </motion.div>
          </div>
